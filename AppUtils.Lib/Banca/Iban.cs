...
namespace AppUtils.Lib.Banca
{
    ...
    public class Iban
    {
        ...
        private static void CaricaCodiciPaese()
        {
            ...
            _INFO_PAESE.Add("EA", new InfoIbanNazione("EA", "EMIRATI ARABI", "EA00BBBCCCCCCCCCCCCCCCC", true, "AED"));
            ...
            _INFO_PAESE.Add("SI", new InfoIbanNazione("SI", "SLOVENIA", "SI00BBSSSCCCCCCCCKK", true, "EUR"));
