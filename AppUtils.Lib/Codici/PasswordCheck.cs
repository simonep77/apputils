...
public class PasswordCheck
{
    ...
    public string getInfoPswLength()
    {
        if (this.MinLength == this.MaxLength)
            return string.Format("Deve essere composta da {0} caratter{1}", this.MinLength, MinLength == 1 ? "e" : "i");
        else
            return string.Format("Deve essere composta da minimo {0} caratter{1} e massimo da {2}", this.MinLength, MinLength == 1 ? "e" : "i", this.MaxLength);
    }
    ...
    public string getInfoPswLowerCase()
    {
        ...
        if (this.MinLowercase < 0)
            ...
            return string.Format("{0}, almeno {1}", strMsg, this.MinLowercase);
    }
    ...
    public string getInfoPswUpperCase()
    {
        ...
        if (this.MinUppercase < 0)
            ...
            return string.Format("{0}, almeno {1}", strMsg, this.MinUppercase);
    }
    ...
    public string getInfoPswNumeri()
    {
        ...
        if (this.MinNumeric < 0)
            ...
            return string.Format("{0}, almeno {1}", strMsg, this.MinNumeric);
    }
    ...
    public string getInfoPswSpecialChars()
    {
        ...
        if (this.MinSpecialChar < 0)
            ...
            return string.Format("{0}, almeno {1}", strMsg, this.MinSpecialChar);
    }
}
